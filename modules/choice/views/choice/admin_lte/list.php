...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<?php echo __('Editor Choice'); ?>
		</h1>
		<ol class="breadcrumb">
			<li><?php echo __('Web Tools'); ?></li>
			<li class="active"><a href="/choice"><?php echo __('Editor Choice'); ?></a></li>
		</ol>
	</section>
	...
	<section class="content">
		<div class="row">
			<div class="col-xs-12">
					...
					<div class="box-body">
						<a href="javascript:PopupCenter('/choice/popup', 'google', '640', '480');"><button type="button" style="width:150px" class="btn btn-success btn-sm"><?php echo __('Add New Editor Choice'); ?></button></a>												<a href="/choice/sync"><button type="button" style="width:150px" class="btn btn-info btn-sm"><?php echo __('Sync'); ?></button></a>
					</div>
				</div>
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title"><?php echo  __('List Editor Choice'); ?></h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
                                                        ...
                                                        if(!empty($data['list'])) {
                                                            ...
                                                            foreach($data['list'] as $v_list) {
                                                                ...
                                                                <tr <?php echo $bg_list; ?>>
                                                                    ...
                                                                    <td>
																		<a href="javascript:del_confirm(<?php echo $v_list['echoId'] ?>)"><button class="btn btn-block btn-danger btn-xs"><?php echo __('Delete'); ?> </button></a> </br></br>
																		<a href="javascript:PopupCenter('/choice/popupchange/<?php echo $v_list['echoId'] ?>/', 'google', '640', '480');"><button type="button" style="width:150px" class="btn btn-success btn-xs"><?php echo __('Change'); ?></button></a>
																	</td>
                                                                </tr>
                                                                <?php
                                                                $c_bg_list++;
