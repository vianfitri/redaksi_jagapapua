<script type='text/javascript'>
    function paste(dom_id, id){
		...
		if(docref == 'http://baca.bismillah.web.id/shenews/new' || docref == 'http://baca.bismillah.web.id/shenews/new/') {
...
<div class="content-wrapper" style="margin-left: 0;">
        ...
        <section class="content-header">
                ...
                <ol class="breadcrumb">
                        <li>Choice</li>
                        <li class="active"><a href="/choice/popuppickupchange">Pop Up</a></li>
                </ol>
        </section>
                        ...
                        <div class="col-xs-12">
                                <div class="box box-primary">
                                        <div class="box-header with-border">
                                                ...
                                                <div class="box-tools">
                                                        <form method="post" action="/choice/popuppickupchange/search/<?php echo $data['id']; ?>/">
