<script type='text/javascript'>
    function paste(id){
        window.opener.post_form_new(id);
        window.close();
    }
</script>
<script>
...
<div class="content-wrapper" style="margin-left: 0;">
        ...
        <section class="content-header">
                ...
                <ol class="breadcrumb">
                        <li>Choice</li>
                        <li class="active"><a href="/choice/popuppickup">Pop Up</a></li>
                </ol>
        </section>
                        ...
                        <div class="col-xs-12">
                                <div class="box box-primary">
                                        <div class="box-header with-border">
                                                ...
                                                <div class="box-tools">
                                                        <form method="post" action="/choice/popuppickup/search">
                                                        ...
                                                        if(!empty($data['list_approved'])) {
                                                            ...
                                                            foreach($data['list_approved'] as $v_approved) {
                                                                ...
                                                                <tr <?php echo $bg_color; ?>>
                                                                        ...
                                                                        <td  width="10%">
                                                                                <a href="javascript:paste('<?php echo $v_approved['id']; ?>')"><button class="btn btn-block btn-success btn-xs">Pickup</button></a><br/>
                                                                        </td>
                                                                </tr>
                                                                <?php
                                                                $i_c++;
