<script type='text/javascript'>
    function paste(dom_id, id){
		...
		if(docref == 'http://baca.bismillah.web.id/choice' || docref == 'http://baca.bismillah.web.id/choice/') {
			window.opener.document.getElementById(dom_id).value = id;
			window.opener.push_ajax();
			window.close();
		} else {
			document.getElementById(dom_id).value = id;
			PopupCenter('/choiceramadan/schedule', 'scheduler', 500, 400)
		}
    }
	function doPaste() {
...
<div class="content-wrapper" style="margin-left: 0;">
        ...
        <section class="content-header">
                ...
                <ol class="breadcrumb">
                        <li>Choice</li>
                        <li class="active"><a href="/choiceramadan">Pop Up</a></li>
                </ol>
        </section>
