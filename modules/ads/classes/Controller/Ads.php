...
class Controller_Ads extends Controller_Backend {
		...
		$this->custom_footer = '
			<script type="text/javascript">
				function del_confirm(id) {
					...
					if (dialog == true) {
						window.location.href="'.URL::base().'ads/delete/" + id;
					}
				}
			</script>
		';
	...
	public function action_new() {
		...
		$data['main_title'] = "New ads ";
		$data['menu_active'] = "ads";
	...
	public function action_categoryNew() {
		$data['main_title'] = "New Category ads";
		$data['menu_active'] = "ads";
	...
	public function action_submit() {
		...
		$ads_model = new Model_ads();
		$result = $ads_model->save_data($this->request->post());
		$this->redirect('/ads/list');
	}
	...
	public function action_categorySubmit() {
		...
		$ads_model = new Model_ads();
		$result = $ads_model->save_data_category($this->request->post());
		$this->redirect('/ads/category/list');
	}
	...
	public function action_list() {
		...
		$data['main_title'] = "List ads";
		$data['menu_active'] = "ads";
		$data['menu_active_child'] = "list";

		$ads_model = new Model_Ads();
		$data['count_all'] = $ads_model->count_all();
		...
		$data['list'] = $ads_model->list_data($pagination->items_per_page, $pagination->offset);
		...
		// print_r(View::factory("ads/list"));exit;
		// print_r($view);exit;
		$this->response->body($view);
	}
	...
	public function action_categoryList() {
		...
		$data['main_title'] = "List Category ads";
		$data['menu_active'] = "ads";
		$data['menu_active_child'] = "category";

		$ads_model = new Model_ads();
		$data['count_all'] = $ads_model->count_all_category();
		...
		$pagination = Pagination::factory(array(
							...
							'items_per_page'	=> 20,
							'current_page'		=> $page,
							'base_url'				=> '/ads/category/list/',
							'view'					=> 'pagination/admin'
						));

		$data['list'] = $ads_model->list_data_category($pagination->items_per_page, $pagination->offset);
		...
		$data['custom_footer'] =  '
												<script type="text/javascript">
													function del_category_confirm(id) {
														var dialog = confirm("' . __('Are you sure for delete this data ?') . '");
														if (dialog == true) {
															window.location.href="'.URL::base().'ads/category/delete/" + id;
														}
													}
												</script>
											';
	...
	public function action_edit() {
		...
		$ads_model = new Model_ads();
		$data['detail'] = $ads_model->data_by_id($id);
	...
	public function action_categoryEdit() {
		...
		$ads_model = new Model_ads();
		$data = $ads_model->data_by_id_category($id);

		$data['main_title'] = "Edit Category ads";
		$data['menu_active'] = "ads";
		$data['menu_active_child'] = "category";
	...
	public function action_update() {
		...
		$ads_model = new Model_ads();
		$update = $ads_model->update_data($id, $this->request->post());
	...
	public function action_categoryUpdate() {
		...
		$id = $this->request->post('id');
		$ads_model = new Model_ads();
		$update = $ads_model->update_data_category($id, $this->request->post());
	...
	public function action_search() {
		...
		if(!empty($post_search)) {
			$this->redirect('/ads/search/' . $post_search);
		}
		...
		// Count All Data
		$data['count_all'] = $ads_model->count_search_data($search);
		...
		$pagination = 	Pagination::factory(array(
							...
							'items_per_page'	=> 20,
							'current_page'		=> $page,
							'base_url'				=> '/ads/search/' . $search . '/',
							'view'					=> 'pagination/admin'
						));

		$data['list'] = $ads_model->search_data($search, $pagination->items_per_page, $pagination->offset);
		$data['search'] = $search;
		$data['pagination'] =  $pagination->render();
		$data['custom_footer'] = $this->custom_footer;
	...
	public function action_categorySearch() {
		...
		$data['main_title'] = "Search Category ads";
		$data['menu_active'] = 'ads';
		$data['menu_active_child'] = 'category';
		...
		$post_search = $this->request->post('search');
		if(!empty($post_search)) {
			$this->redirect('/ads/category/search/' . $post_search);
		}
		...
		// Count All Data
		$data['count_all'] = $ads_model->count_search_data_category($search);
		...
		$pagination = 	Pagination::factory(array(
							...
							'items_per_page'	=> 20,
							'current_page'		=> $page,
							'base_url'				=> '/ads/category/search/' . $search . '/',
							'view'					=> 'pagination/admin'
						));

		$data['list'] = $ads_model->search_data_category($search, $pagination->items_per_page, $pagination->offset);
		$data['search'] = $search;
		$data['pagination'] =  $pagination->render();
		$data['custom_footer'] =  '
												<script type="text/javascript">
	...
	public function action_delete() {
		...
		$ads_model = new Model_ads();
		$update = $ads_model->delete_data($id);
	...
	public function action_categoryDelete() {
		$id = $this->request->param('id');
		$ads_model = new Model_ads();
		$update = $ads_model->delete_data_category($id);
