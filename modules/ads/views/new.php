		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" method="post" action="<?php echo URL::Base(); ?>ads/submit" onsubmit="return checkValid()">
						<div class="box-body">
						...
						<div class="box-footer">
							<button type="submit" class="btn btn-primary"><?php echo __('Simpan'); ?></button>
						</div>
					</form>
				</div>
			</div>
